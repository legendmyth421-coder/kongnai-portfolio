      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Reveal delay={200}>
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <a
              href="mailto:legendmyth421@gmail.com"
              className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-white/5 border border-white/10 hover:border-cyan/50 hover:bg-white/10 transition-all duration-300"
            >
              <svg className="w-5 h-5 text-cyan group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
